...
{
	ftm_init_struct.FTM_Ftmx = pwm->FTM_Ftmx; //使能FTM1通道
	ftm_init_struct.FTM_Mode = FTM_MODE_PWM; //使能PWM模式
	ftm_init_struct.FTM_PwmFreq = FTM_PwmFreq; //PWM频率100Hz
	ftm_init_struct.FTM_PwmDeadtimeCfg = DEADTIME_CH01;
	ftm_init_struct.FTM_PwmDeadtimeDiv = DEADTIME_DIV16;
	ftm_init_struct.FTM_PwmDeadtimeVal = 63;
